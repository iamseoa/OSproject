...
CNNModel model;
Task task_pool[NUM_INPUTS];
TaskQueue queue;
int task_done_count = 0;
atomic_int producer_finished = 0;
pthread_mutex_t task_done_mutex = PTHREAD_MUTEX_INITIALIZER;
...
int main() {
    ...
    struct rusage usage_self_start, usage_self_end;
